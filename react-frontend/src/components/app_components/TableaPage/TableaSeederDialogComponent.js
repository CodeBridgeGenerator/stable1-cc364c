...
import seederData from "./tablea.seeder.json";
...
const TableaSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TableaSeederDialogComponent);

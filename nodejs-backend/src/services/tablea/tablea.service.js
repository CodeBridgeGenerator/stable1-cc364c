const { Tablea } = require("./tablea.class");
const createModel = require("./tablea.model");
const hooks = require("./tablea.hooks");
...
module.exports = function (app) {
  ...
  app.use("/tablea", new Tablea(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("tablea");

  // Get the schema of the collections 
  app.get("/tableaSchema", function (request, response) {
